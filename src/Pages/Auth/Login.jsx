                    ...
                    <AnimatedBorder borderSize="600">
                         <div className="bg-midnight/95 backdrop-blur-xl rounded-3xl p-8 shadow-2xl w-full">
                              ...
                              <form onSubmit={handleSubmit} className="space-y-4 relative">
                                   ...
                                   <button
                                        type="submit"
                                        className="w-full py-4 rounded-xl font-semibold text-white bg-gradient-to-r from-electric-purple via-cosmic-purple to-electric-purple hover:brightness-115 hover scale-102 transition-all duration-300 "
                                   >
                                        Sign In
                                   </button>
