          ...
          <section className="bg-void text-white flex flex-col gap-3 rounded-xl">
               ...
               >
                    {DashboardPageRatingData.map((item) => (
                         <div
                              key={item.Content}
                              className=" flex-1/4 w-full h-auto bg-midnight rounded-xl relative overflow-hidden"
                         >
                              <span
                              ...
                              <div className=" w-full h-full flex justify-center items-center gap-3 px-8 py-5">
                                   <div className="w-full h-full flex flex-col justify-center items-start gap-4">
                                        ...
                                        <div className="w-full text-slate max-sm:text-center">
                                             {item.Content}
                                        </div>
                                   </div>
               ...
               {/* <div className="w-full h-max p-8 flex flex-col gap-3 bg-midnight rounded-xl">
                    ...
                    <div className="flex gap-4 items-center">
                         ...
                         <div className="w-0 h-0 border-l-transparent border-l-[18px] border-r-transparent border-r-[18px] border-b-[14px] border-slate"></div>
                         <p className="text-slate">last month $563,443</p>
                    </div>
               ...
               <div className="w-full h-full flex gap-5">
                    <div className="flex-1/2 w-full h-full p-6 flex justify-center items-center bg-midnight text-white rounded-xl">
                         <DashboardLineChart />
                    </div>
               </div> */}
          </section>
